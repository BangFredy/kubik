...
*/
##############################################################################################################
$config['deviceCode'] 		= '864877036850697';
$config['tk'] 				= 'ACCEYJdA1wdAd6qK1RyEsfiR7bKDJUxLG0hxdHRodw';
$config['token'] 			= '1be9D2VPp475Yiye_ZuaLZvWfE5flwtZT1w40V090H3eslByjxdNEwI6TlobaHltNSN1H-YEXkkZRGQ';
$config['uuid'] 			= 'd77b42a9d2604ed3ae887e5711649e2c';
$config['sign'] 			= 'db0b90aa9bd3b15294fe42e26923edd7';
$config['android_id'] 		= 'cd384d0faecfaa54';
##############################################################################################################
for ($x=0; $x <1; $x++) { 
	$url 	= array(); 
